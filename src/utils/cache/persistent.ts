 ...
 * @LastEditTime: 2023-04-22 18:36:09
 * @FilePath: /v3ts-lockin/src/utils/cache/persistent.ts
...
function initPersistentMemory() {
  ...
  // 将localCache和sessionCache中的key-value存入memory中，并加上超时时间
...
window.addEventListener('beforeunload', function () {
  ...
  // LOCK_INF_KEY 在锁屏和解锁时写入，此处也不应修改
  debugger;
